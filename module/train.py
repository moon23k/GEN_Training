...
class Trainer(TrainerBase):
    def __init__(self, config, model, train_dataloader, valid_dataloader):
        super(Trainer, self).__init__(config, model, train_dataloader, valid_dataloader)
...
class GenTrainer(TrainerBase):
    def __init__(self, config, model, train_dataloader, valid_dataloader):
        super(GenTrainer, self).__init__(config, model, train_dataloader, valid_dataloader)
